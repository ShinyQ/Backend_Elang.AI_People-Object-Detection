...
with open("../app/image/street.jpg", "rb") as image_file:
...
def drawboundingbox(img, boxes, pred_cls, rect_th=2, text_size=0.8, text_th=2):
...
img = Image.open("../app/image/street.jpg")
